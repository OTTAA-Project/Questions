...
public class MovableFloatingActionButton extends LinearLayout implements View.OnTouchListener {
    ...
    public boolean onTouch(View view, MotionEvent motionEvent){
        ...
        if (action == MotionEvent.ACTION_DOWN) {
            ...
            if (newX+viewWidth/2 > parentWidth/2) {
                view.setLayoutDirection(LAYOUT_DIRECTION_LTR);
                view.setBackground(view.getContext().getResources().getDrawable(R.drawable.movable_button_rigth));
            }
            else {
                view.setLayoutDirection(LAYOUT_DIRECTION_RTL);
                view.setBackground(view.getContext().getResources().getDrawable(R.drawable.movable_button_left));
            }
            view.animate()
                    .x(newX)
                    .y(newY)
